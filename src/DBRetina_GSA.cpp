...
namespace DBRetina {
    ...
    private:
        ...
        hashed_MAP pathway_to_gene_set;
        uint64_t n_total_pathways;
        flat_hash_map<string, double> pathway_to_average_PSI;

        // specific for clusters part (Pathway Pleiotropy Index)
        ...
        parallel_flat_hash_set<uint64_t> get_universe_set(flat_hash_set<string> pathways) {
            // TODO optimize pass by reference
            parallel_flat_hash_set<uint64_t> universe_set;
